                                ...
                                <div key="catalog" className="container mx-auto px-4 py-24">
                                    <RevealOnScroll>
                                        <div className="flex justify-between items-end mb-12">
                                            <div>
                                                <h2 className="text-3xl font-black mb-2">{catalogTitle}</h2>
                                                <p className="text-slate-500 dark:text-slate-400">{catalogSubtitle}</p>
                                            </div>
                                            <Link
                                                to="/catalog"
                        ...
                        case 'partners':
                            return (
                                <div key="partners" id="partners">
                                    <Partners partners={partners} title={t.trustedPartners} content={section.content} lang={lang} />
                                </div>
                            );
                        case 'about':
                            return <About key="about" t={t} content={section.content} lang={lang} />;
                        default:
