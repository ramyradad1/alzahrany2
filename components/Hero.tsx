    ...
    <div className="relative bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-white overflow-hidden min-h-[700px] flex items-center transition-colors duration-500 perspective-1000">
      ...
      {content?.image ? (
        <div className="absolute inset-0 z-0">
          <img src={content.image} alt="Hero Background" className="w-full h-full object-cover opacity-30 dark:opacity-40" />
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            {isDefaultTitle ? (
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-slate-900 to-cyan-600 dark:from-white dark:to-cyan-400">
                {title}
              </span>
            )}
          </h1>
          ...
          <p
            className="text-lg md:text-2xl text-slate-600 dark:text-slate-300 mb-12 leading-relaxed max-w-2xl mx-auto animate-fade-in-up whitespace-pre-wrap"
